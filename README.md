...
Table 1. List of cities included in the dataset and their corresponding city indexes according to different rankings. The dashed line indicates the absence of the city in the particular ranking system.
City IATA Code
Overall Arcadis SCI
Planet Arcadis SCI
People Arcadis SCI
Profit Arcadis SCI
Sustainable cities by Corporate Knights
Resilient Cities by Grosvenor
Global Cities by AT Kearney
